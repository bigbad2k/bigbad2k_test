...
interface INetworkPolicyManager {
    ...
    //FEATURE_POWERSAVER
    void setUidPolicyPersist(int uid, int policy, boolean persist);
...
//#ifdef FEATURE_SKY_DS_RESTRICT_BACKGROUD_WIFI
    void setRestrictBackgroundWifi(boolean restrictBackground);
//#endif /*FEATURE_SKY_DS_RESTRICT_BACKGROUD_WIFI*/

//kkn
	void setRestrictBackgroundKKN(boolean restrictBackground);
